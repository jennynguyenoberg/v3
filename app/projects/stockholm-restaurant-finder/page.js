...
export const metadata = {
  title: "Stockholm Restaurant Finder",
  description: "Project 2 | Jenny Nguyen Öberg",
};

export default function ProjectTwo() {
  const projectIdToShow = "stockholm-restaurant-finder";
  ...
  return (
    <>
      ...
      <Link href={`/projects/pomodoro-timer`} className={styles.button}>
